...
pathlist = Path('RESULTS_WITHOUT_RECALCULATION_CENTERS').glob('Centroids_After_*.csv')
for path in pathlist:
         ...
         input_file = "RESULTS_WITHOUT_RECALCULATION_CENTERS/"+path_in_str.removeprefix("RESULTS_WITHOUT_RECALCULATION_CENTERS/Centroids_After_")
