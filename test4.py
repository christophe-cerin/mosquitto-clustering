...
pathlist = Path('RESULTS_KEAMSPLUSPLUS_DATA_WITHOUT_TIME').glob('Centroids_After_*.csv')
for path in pathlist:
         ...
         input_file = "RESULTS_KEAMSPLUSPLUS_DATA_WITHOUT_TIME/"+path_in_str.removeprefix("RESULTS_KEAMSPLUSPLUS_DATA_WITHOUT_TIME/Centroids_After_")
