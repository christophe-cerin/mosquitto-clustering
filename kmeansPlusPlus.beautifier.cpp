...
KmeansPlusPlus::KmeansPlusPlus (int k, int pointnumber):
Kmeans (k, pointnumber)
{

}

KmeansPlusPlus::KmeansPlusPlus (int k):
Kmeans (k)
{
...
int
KmeansPlusPlus::NearestCenter (Point & p, int alreadyInitCenterNumber,
			       float &minDistance)
{
...
#endif
    for (int k = 0; k <= alreadyInitCenterNumber; k++)
    {
